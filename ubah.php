    ...
    <div class="style-box">
        <form action="" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" id="nama" name="nama" value="<?= $pasien["nama"]; ?>" id="nama" required>
                </div>
            </div><br>
            <div class="form-group row">
                <label for="alamat" class="col-sm-2 col-form-label">Alamat</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" id="alamat" name="alamat" value="<?= $pasien["alamat"]; ?>" id="alamat" required>
                </div>
            </div><br>
            <fieldset class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="kategori" id="remaja" value="Remaja" <?= $pasien['kategori'] == 'Remaja' ? 'checked' : '' ?>>
                        <label class="form-check-label" for="remaja">
                        Remaja
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="kategori" id="dewasa" value="Dewasa" <?= $pasien['kategori'] == 'Dewasa' ? 'checked' : '' ?> >
                        <label class="form-check-label" for="dewasa">
                        Dewasa
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="kategori" id="lansia" value="Lansia" <?= $pasien['kategori'] == 'Lansia' ? 'checked' : '' ?> >
            ...
            <fieldset class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jk" id="jk" value="Pria" <?= $pasien['jenisKelamin'] == 'Pria' ? 'checked' : '' ?> >
                        <label class="form-check-label" for="jk">
                        Pria
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jk" id="jk" value="Wanita" <?= $pasien['jenisKelamin'] == 'Wanita' ? 'checked' : '' ?>>
                        <label class="form-check-label" for="jk">
                        Wanita
                        </label>
                    </div>
            ...
            <button type="submit" class="btn btn-primary" name="btnSubmit" >Edit Data Pasien</button><br><br>
